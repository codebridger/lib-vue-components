...
```bash
# Using npm
npm install @tiny-ideas-ir/lib-vue-components

# Using yarn
yarn add @tiny-ideas-ir/lib-vue-components

# install from dev branch
yarn add @tiny-ideas-ir/lib-vue-components@dev
```
...
import '@tiny-ideas-ir/lib-vue-components/style.css';
...
export default defineNuxtConfig({
  ...
  build: {
    transpile: ['@tiny-ideas-ir/lib-vue-components'],
  },

  css: [
    // ... other CSS files
    '@tiny-ideas-ir/lib-vue-components/style.css',
  ],
