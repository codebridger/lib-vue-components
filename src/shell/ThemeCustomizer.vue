    ...
    >
      ...
      >
        <div>
          ...
          <div
            class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3"
          >
            <h5 class="mb-1 text-base dark:text-white leading-none">
              Color Scheme
            </h5>
          ...
          >
            ...
            <div class="grid grid-cols-3 gap-2 mt-3">
              <button
                ...
                class="btn"
                :class="[
                  store.menu === 'horizontal'
                    ? 'btn-primary'
                    : 'btn-outline-primary',
                ]"
                @click="store.toggleMenuStyle('horizontal')"
              >
                Horizontal
              </button>
              <button
                ...
                @click="store.toggleMenuStyle('vertical')"
              >
                Vertical
              </button>
              <button
                ...
                class="btn"
                :class="[
                  store.menu === 'collapsible-vertical'
                    ? 'btn-primary'
                    : 'btn-outline-primary',
                ]"
                @click="store.toggleMenuStyle('collapsible-vertical')"
              >
                Collapsible
              </button>
            </div>
